...
service construction. Its exact Core/Operations and Interpreters revisions
come from the coordinate manifest and must match package/Dockerfile pins.
Counting pins does not verify registry bytes or execute an image.
