...
Servers #177 synchronizes this Core-only mirror to canonical CPK merge `e3e29995a4ffc6e6645c2b35d41f394438464d2d`. Gateway process source and the published image coordinate are unchanged. Gateway replay protection remains separately tracked by #176 before affected live acceptance.
