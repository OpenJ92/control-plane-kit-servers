Source: [scripts/cpk_server_workspace_b_multiplexer_observer_smoke.sh](../../../scripts/cpk_server_workspace_b_multiplexer_observer_smoke.sh).
Maintain this document alongside its source file. When the source or relevant imported contracts change, verify and update this companion in the same change.

This five-line entry point sets CPK_HOSTED_ACTIVITY_SCENARIO to
`workspace-b-multiplexer-observer` for one invocation of the
